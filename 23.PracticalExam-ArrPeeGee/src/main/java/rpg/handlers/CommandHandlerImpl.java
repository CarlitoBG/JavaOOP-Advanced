...
public class CommandHandlerImpl implements CommandHandler {
    ...
    private static final String COMMAND_CLASS_PATH = "rpg.commands.specificCommands.";
    ...
    public void executeCommand(String command, List<String> params) throws ClassNotFoundException, IllegalAccessException,
