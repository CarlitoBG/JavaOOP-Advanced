...
public class HeroControllerImpl implements HeroController {
    ...
    @Override
    public String createRecipe(String itemName, String heroName, int strength, int agility, int intelligence, int hitPoints,
                               int damage, List<String> requiredItems) {
    ...
    public String inspect(String heroName) throws IllegalAccessException {
        ...
        sb.append(String.format("Hero: %s, Class: %s", heroName, hero.getClass().getSimpleName())).append(System.lineSeparator())
                ...
                .append(String.format("Items:%s", hero.getItems().size() == 0 ? " None" : "")).append(System.lineSeparator());
    ...
    public String quit() {
        ...
        for (Hero hero : heroes) {
            sb.append(String.format("%d. %s", counter++, hero)).append(System.lineSeparator());
        }
