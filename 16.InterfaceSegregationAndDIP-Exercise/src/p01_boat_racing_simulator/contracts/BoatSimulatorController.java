...
public interface BoatSimulatorController {
    ...
    String createYacht(String model, int weight, String engineModel, int cargoWeight) throws NonExistentModelException,
    ...
    String signUpBoat(String model) throws NonExistentModelException, NoSetRaceException, DuplicateModelException;
