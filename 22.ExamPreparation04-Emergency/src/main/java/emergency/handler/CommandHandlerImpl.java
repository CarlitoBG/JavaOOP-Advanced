...
public class CommandHandlerImpl implements CommandHandler {
    ...
    private static final String COMMAND_CLASS_PATH = "emergency.commands.specificCommands.";
    private static final String COMMAND_CLASS_NAME_SUFFIX = "Command";

    private List<String> params;
    private ManagementSystem emergencyManagementSystem;

    public CommandHandlerImpl(ManagementSystem emergencyManagementSystem) {
